...
define('OGP_LANG_failure', "שגיאה , נכשל ביצירת קובץ הכינוי");
...
define('OGP_LANG_fast_dl', "הפניית הורדות מחדש (FastDL)");
...
define('OGP_LANG_no_aliases_defined', "אין עדיין כינויי רשת שהוגדרו על ידי OGP לשרת מרוחק זה.");
define('OGP_LANG_fastdl_port', "פורט");
define('OGP_LANG_fastdl_port_info', "הפורט שעליו יתחיל ה Fast Download שלך.");
define('OGP_LANG_fastdl_ip', "כתובת");
define('OGP_LANG_fastdl_ip_info', "כתובת האייפי או הדומיין בו יתחיל שרת ההורדה המהירה שלך, יש לרשום את התחום ב- /etc/hosts.");
define('OGP_LANG_listing', "רישום");
...
define('OGP_LANG_stop_fastdl', "עצור את Fast Download");
define('OGP_LANG_fast_download_daemon_running', "Fast Download פועל.");
define('OGP_LANG_fast_download_daemon_not_running', "Fast Download לא פועל.");
define('OGP_LANG_fastdl_could_not_be_restarted', "לא ניתן היה להפעיל מחדש את Fast Download.");
...
define('OGP_LANG_match_client_ip', "התאם אייפי לקוח");
define('OGP_LANG_match_client_ip_info', "ינתנו חיבורים עם אייפי תואם,<br> ריק לגישה בלתי מוגבלת. באפשרותך להשתמש<br>במספר כתובות IP או טווחים המופרדים באמצעות פסיק:<br> /xx subnets <br> לדוגמא: 10.0.0.0/16<br> /xxx.xxx.xxx.xxx subnets<br>לדוגמא: 10.0.0.0/255.0.0.0<br>טווחי מקף<br>לדוגמא:10.0.0.5-230<br>התאמת כוכבית<br>לדוגמא:10.0.*.*");
...
define('OGP_LANG_autostart_on_agent_startup_info', "התחל את הFASTDL Daemon באופן אוטומטי כאשר הסוכן מתחיל");
define('OGP_LANG_port_forwarded_to_80', "פורט הועבר מ-80");
define('OGP_LANG_port_forwarded_to_80_info', "הפעל אפשרות זו אם היציאה המוגדרת ל Fast Download שלך הועברה מהפורט 80, כך שהפורט יוסתר בכתובות URL.");
