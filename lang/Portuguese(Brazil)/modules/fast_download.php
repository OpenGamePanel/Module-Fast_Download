...
define('OGP_LANG_fast_download_service_for', "Serviço de redirecionamento de downloads para %s");
define('OGP_LANG_to_the_path', "Para o caminho");
define('OGP_LANG_at_url', "em URL");
define('OGP_LANG_create_alias_for', "Criar alias para");
define('OGP_LANG_fast_dl', "Redirecionando downloads (FastDL)");
define('OGP_LANG_current_aliases_at_remote_server', "Aliases atuais no servidor remoto");
define('OGP_LANG_delete_selected_aliases', "Excluir aliases selecionados");
...
define('OGP_LANG_fastdl_port_info', "Porta no qual seu o seu Fast Download Daemon irá começar.");
define('OGP_LANG_fastdl_ip', "Endereço");
define('OGP_LANG_fastdl_ip_info', "O endereço IP ou domínio no qual seu servidor de Fast Download será iniciado, o domínio deve estar listado em /etc/hosts.");
...
define('OGP_LANG_apply_settings_and_restart_fastdl', "Salve a configuração do daemon e reinicie-o");
